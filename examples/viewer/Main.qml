...
ApplicationWindow {
    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            CheckBox {
                text: qsTr("Auto-bind VM")
                checked: rive.autoBindViewModel
                onClicked: rive.autoBindViewModel = checked
                ToolTip.text: qsTr("Off: leave the view-model unbound. " +
                                   "Use bindViewModelInstance() to attach one explicitly.")
