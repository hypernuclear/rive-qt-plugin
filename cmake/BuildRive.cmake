...
"    #\n"
"    # PLATFORM=ARM64 (uppercase) because premake's arch field is\n"
"    # case-sensitive: allowed values are the constants from\n"
"    # src/base/_foundation.lua which are defined uppercase\n"
"    # (premake.AARCH64 = \"AARCH64\"), and the alias map keys are\n"
"    # also uppercase (ARM64 = p.AARCH64). Lowercase arm64 / aarch64\n"
"    # both get rejected with 'invalid value' errors.\n"
"    $Env:PLATFORM = 'ARM64'\n"
"    Push-Location $premakeCore\n"
"    try {\n"
"        & nmake /NOLOGO -f Bootstrap.mak windows MSDEV=vs2022 PLATFORM=ARM64\n"
