...
if(WIN32)
    ...
    # Use the official prebuilt premake5.exe we vendor in cmake/vendor/.
    # Rationale: building premake from source on Windows goes through
    # premake's own bootstrap + Bootstrap.bat + devenv /Build chain, and
    # at least three of those steps have upstream bugs specific to recent
    # VS 2022 toolsets (see commit history if you're curious).
    # The prebuilt x86-64 binary runs natively on Windows x64 and under
    # emulation on Windows ARM64 — same binary for both.
...
"}\n"
"\n"
"# Ensure fxc/msbuild are on PATH (Qt Creator's MSVC kit usually\n"
"# provides them, but bare shells won't).\n"
"if (-not (Get-Command fxc -ErrorAction SilentlyContinue)) {\n"
"    & '${_rive_setup_ps1_native}'\n"
"}\n"
"\n"
"# Scrub PLATFORM (Qt Creator's ARM64 kit sets it; rive's build script\n"
"# doesn't need it and some paths forward it into tool invocations).\n"
"Remove-Item Env:PLATFORM -ErrorAction SilentlyContinue\n"
"\n"
"# Install the vendored premake5.exe where rive's script expects it.\n"
"# Both names so rive's `[ ! -f premake5 ]` check passes (it tests for\n"
...
"\n"
"# Hand off to rive's script — it'll see premake5 installed and skip\n"
