...
if(WIN32)
    ...
    file(TO_NATIVE_PATH "${RIVE_RUNTIME_DIR}/build/build_rive.ps1" _rive_build_ps1_native)
    # NOTE: upstream's build_rive.ps1 delegates the real work to
    # `sh build_rive.sh` — bash is on the critical path. Qt Creator's
    # build env doesn't inherit Git-for-Windows' `usr\bin\` (where sh.exe
    # lives), so we locate sh ourselves and prepend its directory to PATH
    # before handing off to rive's ps1. That keeps upstream's
    # setup_windows_dev.ps1 (VsDevShell for msbuild/fxc) in play.
...
"}\n"
"\n"
"# Ensure sh.exe is discoverable. Rive's ps1 literally does `sh build_rive.sh`.\n"
...
"}\n"
"\n"
"& '${_rive_build_ps1_native}' '${RIVE_CONFIG}'\n"
"exit $LASTEXITCODE\n")
else()
