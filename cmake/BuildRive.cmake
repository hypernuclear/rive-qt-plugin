...
"\n"
"    # Locate VsDevShell — check Enterprise then Community.\n"
"    $vsCandidates = @(\n"
...
"        if (Test-Path $p) { $vsDevShell = $p; break }\n"
"    }\n"
"    if (-not $vsDevShell) {\n"
"        Write-Error 'Launch-VsDevShell.ps1 not found. Install VS 2022 with MSVC ARM64 build tools.'\n"
"        exit 1\n"
"    }\n"
"\n"
"    # Initialize the dev env for ARM64 host + ARM64 target.\n"
"    # (Rive's setup_windows_dev.ps1 calls this with no args and gets x64.)\n"
"    & $vsDevShell -HostArch arm64 -Arch arm64 -SkipAutomaticLocation\n"
"    if (-not (Get-Command cl -ErrorAction SilentlyContinue)) {\n"
"        Write-Error 'cl.exe not on PATH after VsDevShell init — ARM64 MSVC tools may not be installed.'\n"
"        exit 1\n"
"    }\n"
"\n"
"    # Fresh clone.\n"
