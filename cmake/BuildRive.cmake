...
"\n"
"    # Fast path: if a pre-built premake5.exe already sits at the\n"
"    # canonical MSBuild output location (bin/release/), use it\n"
"    # directly. Lets a developer who manually built premake in VS\n"
"    # skip our whole bootstrap pipeline.\n"
"    $prebuilt = Join-Path $premakeCore 'bin\\release\\premake5.exe'\n"
"    if (Test-Path $prebuilt) {\n"
"        $prebuiltArch = Get-PeMachine $prebuilt\n"
"        if ($prebuiltArch -eq 'arm64') {\n"
"            Write-Host \"=== Using pre-built ARM64 premake5.exe at $prebuilt ===\"\n"
"            New-Item -ItemType Directory -Force -Path $installDir | Out-Null\n"
"            Copy-Item -Force $prebuilt (Join-Path $installDir 'premake5.exe')\n"
"            Copy-Item -Force $prebuilt (Join-Path $installDir 'premake5')\n"
"        } else {\n"
"            Write-Host \"Pre-built premake5.exe at $prebuilt is '$prebuiltArch', not arm64; ignoring and bootstrapping fresh.\"\n"
"        }\n"
"    }\n"
"}\n"
"\n"
